"""
Django settings for regression1_41 project.
...
ROOT_URLCONF = 'regression1_41.urls'
...
WSGI_APPLICATION = 'regression1_41.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "regression1_41 API",
    "DESCRIPTION": "API documentation for regression1_41 App",
    "VERSION": "v1",
}
